import cv2 as opencv-python.cv2
...
st.markdown("<h1 style = 'color: #FF6000'>THE REPUBLIC OF KOREA INTERNATIONAL AIRPORT </h1> ", unsafe_allow_html = True)
st.markdown("<h6 style = 'top_margin: 0rem; color: #27E1C1'>Built by Ogechi Cynthia Eze</h6>", unsafe_allow_html = True)

#Add an Image to the page
st.image('FACE_IMAGE_5.png', caption = 'FACE DETECTOR', width = 600)
...
# st.button("SUBMIT")
if (st.button("SUBMIT")):
    st.write (f"Welome {user_name} to the Republic of Korea International Airport!!!")
